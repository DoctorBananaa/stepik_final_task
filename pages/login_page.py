...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert 'login' in self.browser.current_url, 'Это не страница логина, url другой'
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.REGISTER_PASSWORD1_FIELD).send_keys(password)
        self.browser.find_element(*LoginPageLocators.REGISTER_PASSWORD2_FIELD).send_keys(password)
